...
from tensorflow.python.keras.layers import Embedding, Input, Flatten, Lambda, LSTM
...
def DSCN(embedding_size='auto', cross_num=2, dnn_hidden_units=(1000, 512,), l2_reg_embedding=1e-5,
    ...
    input_action_feature = LSTM(action_embedding_dim)(input_action_embedding)
    input_service_feature = LSTM(service_embedding_dim)(input_service_embedding)
    ...
    concat_output = tf.keras.layers.Dropout(concat_output)
