...
from tensorflow.keras.layers import Activation, Embedding, Input, Flatten, Lambda, CuDNNLSTM, LSTM
...
def DSCN(embedding_size='auto', cross_num=2, dnn_hidden_units=(1000, 512,), l2_reg_embedding=1e-5,
    ...
    input_action_feature = SeqEmbedding(action_num, action_embedding_dim, type='srum')(input_action)
    input_service_feature = SeqEmbedding(service_num, service_embedding_dim, type='sum')(input_service)
